...
const Guesthome = () => {
  ...
  return (
    <div className="guest-home" style={{marginTop:'800px'}}>
      {/* Navigation Header */}
      <nav className="nav-header">
        ...
        <div className="nav-right">
          <Link to="/login" className="auth-button login">Нэвтрэх</Link>
          <Link to="/signup" className="auth-button signup">Бүртгүүлэх</Link>
        </div>
      </nav>

      {/* Hero Section */}
      <div className="hero-section" style={{marginTop:'100px'}}>
        <img 
          src="/home_poster.jpg" 
